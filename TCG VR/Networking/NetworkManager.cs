...
public class NetworkManager : MonoBehaviourPunCallbacks
{
    ...
    public static event Action OnNickNameSet;
    ...
    public override void OnJoinedRoom()
    {
        ...
        if (m_createdRoom)
        {
            NetworkManager.SetCustomPropertySafe("gameState", GameState.BEFORE_PRESENTATION);
            NetworkManager.OnRoomCreated();
        }
        else
        {
            NetworkManager.OnExistingRoomJoined();
        }
    ...
    {
        RoomPropsChanged(propertiesThatChanged);
    }
    #endregion
}
